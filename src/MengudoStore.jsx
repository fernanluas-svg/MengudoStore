...
const confiançaCards = [
  {
    ...
    descricao: "Todos os links levam para a Shopee e para o Mercado Livre, onde sua compra é protegida.",
    icone: (
  ...
  },
  {
    ...
    descricao: "Os produtos são enviados conforme a logística da Shopee e do Mercado Livre.",
    icone: (
      <svg className="w-6 h-6 sm:w-8 sm:h-8 drop-shadow-[0_0_8px_rgba(16,185,129,0.8)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full">
        ...
        <div>
          ...
          <p className="text-sm text-slate-400 mt-1">
            Todos os produtos deste site direcionam para a Shopee e para o Mercado Livre, duas das maiores plataformas de e-commerce da América Latina.
          </p>
        </div>
      </div>
      <div className="grid grid-cols-2 gap-3 sm:gap-4 md:grid-cols-3 lg:grid-cols-4">
